...
Use `workers-rs` official APIs. `apps/trpc-api` owns HTTP/WebSocket routing and calls Bunting adapters; the remaining directories under `workers/` are consumer scaffolds.
