...
pub fn render(frame: &mut Frame, area: Rect) {
    ...
    let lines = vec![
        ...
        Line::from(""),
        Line::from("Trading ----------------------------------------------------------"),
        Line::from("↑ / ↓           Select a live FIX order-book level"),
        Line::from("X               Set the persistent quick-order quantity"),
        Line::from("Enter           Take the selected price using the preset quantity"),
        Line::from("B / S           Buy or sell at that price using the preset quantity"),
        Line::from("2 then B / S    Open a reviewed buy or sell order ticket"),
        Line::from("Tab / Shift-Tab Move through ticket fields"),
        Line::from("Left / Right    Change limit or market order type"),
        Line::from("Ticket Enter    Advance field, then submit the reviewed order"),
