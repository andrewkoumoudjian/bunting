...
- cli-candlestick-chart version 0.24.0 from the same pinned Longbridge tree: the chart package and its ANSI-to-TUI renderer pattern are used for the FIX order-book graph. Copyright (c) 2021 Julien-R44, MIT License.
